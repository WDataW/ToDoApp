...
function ChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        " border-border/50 text-black bg-background grid min-w-[9.5rem] items-start gap-1.5 rounded-lg border px-2.5 py-1.5 text-xs shadow-xl",
        className
      )}>
            ...
            <div
              ...
              {formatter && item?.value !== undefined && item.name ? (
                ...
                <>
                  ...
                  <div
                    className={cn(
                      "flex flex-1 justify-between me-[0.2rem] text-nowrap leading-none",
